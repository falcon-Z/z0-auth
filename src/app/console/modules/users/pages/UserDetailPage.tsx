  ...
  if (error || !user) {
    return (
      <div className="space-y-6">
        <EntityDetailLayout backTo="/users" backLabel="Users" name="User" tabs={[]}>
    ...
    <EntityDetailLayout
      ...
      badges={
        <>
          ...
          {user.isInstanceMember ? <Badge variant="outline">Team member</Badge> : null}
          {user.isBootstrap ? <Badge variant="outline">Created account</Badge> : null}
        </>
      }
      tabs={[]}
      actions={
